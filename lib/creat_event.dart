          ...
          children: [
            ...
            DefaultTabController(
                ...
                child: TabBar(
                    ...
                    ,tabs: CatgoryItem.catgorys.map((catgoryTiem)=>TabItem(catgoryItem: catgoryTiem,selectedBack: AppThem.primary,selectedFor: AppThem.white,unSelectedFor: AppThem.primary,unSelectedborder: AppThem.primary,isSelected:currentIndex==CatgoryItem.catgorys.indexOf(catgoryTiem),)).toList())),
Expanded(
  child:
  Padding(
    padding: EdgeInsets.all(16),
    child: Form(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 8,),
          DeafultTextformfield(numOfLines: 4,hintText: "Event Description",controller:titleController,validator: (value){
            if(value==null||value.isEmpty){
